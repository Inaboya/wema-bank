...
function SignIn() {
  ...
  const routeToSignUnPage = () => navigate("/");
  ...
  const toggleModal = () => setShowPassword(!showPassword);
    ...
    <div className="w-screen h-full bg-[#F5F6F8] px-4 py-2 lg:px-20 lg:py-8 flex flex-col gap-8 lg:gap-14">
      <div className="w-full flex flex-col gap-4 md:flex-row md:justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={routeToSignUnPage}
            className="px-4 py-2 border border-[#039BF0] rounded-[4px] text-[#039BF0] text-[14px] font-semibold"
          >
            Sign Up
          </button>
        </div>
      ...
      <div className="lg:px-60">
        <div className="flex justify-center items-center flex-col p-6 rounded-[8px] bg-[#fff]">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2">
              <p className="text-[14px] text-[#606060] font-medium">
                Forgot Password?
              </p>
              <button
                type="button"
                className="border-none outline-none text-[14px] text-[#039BF0] font-[500]"
              >
                Reset it
              </button>
            </div>
            ...
            <button
              ...
              className="w-full p-3 bg-[#039BF0] rounded-[4px] text-center text-[#fff]"
            >
              Sign in
            </button>
          </div>
